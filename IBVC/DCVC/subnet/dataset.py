...
class UVGDataSet(data.Dataset):
    ...
    def getbpp(self, ref_i_folder):
        ...
        if ref_i_folder == 'H265L20':
            print('use H265L20')
            Ibpp = [1.213396484375, 0.6849548339843748, 0.8600716145833333, 0.6581201985677083, 0.6985362955729166,
                    0.7548777669270834, 0.6584032389322916]  # you need to fill bpps after generating crf=20
