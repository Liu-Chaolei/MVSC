...
def generate_video(
    ...
    if generate_type == "i2v":
        ...
        if image_or_video_path and image_or_video is None:
            raise Exception("trainning pipeline do not support input image_or_video_path")
    ...
    if output_path:
        raise Exception("trainning pipeline do not support output the generated video")
...
def main():
    caption = 'Beautify this video.'
    t2v_model = '/data/ssd/liuchaolei/models/CogVideoX1.5-5B'
    video_path = '/data/ssd/liuchaolei/tmpvideo/MarketPlace1_1920x1080_60fps_10bit_420.yuv'
    num_frames = 60
    output_path = 'tmp_oupt.mp4'
    num_inference_steps = 1
    generate_video(caption, t2v_model, num_frames=num_frames, output_path=enhance_output, image_or_video_path=video_path, num_inference_steps=num_inference_steps)